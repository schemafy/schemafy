...
export const MemoThread = ({ id, comments, setShowThread }: MemoThreadProps) => {
  ...
  return <div className="bg-schemafy-bg rounded-lg shadow-lg p-4 min-w-[300px] text-schemafy-text flex-col gap-4 flex">
