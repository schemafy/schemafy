...
class SameCommandReplayRegistryTest {
  ...
  private static Stream<Arguments> supportedOperations() {
    return Stream.of(
        Arguments.of(ErdOperationType.CHANGE_TABLE_NAME, ChangeTableNameCommand.class),
        ...
        Arguments.of(ErdOperationType.CHANGE_RELATIONSHIP_KIND, ChangeRelationshipKindCommand.class),
