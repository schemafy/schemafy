...
public class ProjectInvitationApiSnippets extends RestDocsSnippets {
  ...
  /** Invitation 생성 응답 필드 (ProjectInvitationCreateResponse) */
  ...
  /** Invitation 조회 응답 필드 (ProjectInvitationResponse) */
  ...
  public static Snippet createInvitationRequest() {
    return requestFields(
        ...
        fieldWithPath("role").type(JsonFieldType.STRING).description("초대 역할 (admin/editor/viewer)"));
  }
  ...
  public static Snippet acceptInvitationResponse() {
    return createResponseFieldsSnippet(
        successResponseFields(new FieldDescriptor[] {
          fieldWithPath("result.projectId").type(JsonFieldType.STRING).description("프로젝트 ID"),
          ...
          fieldWithPath("result.role").type(JsonFieldType.STRING).description("프로젝트 역할"),
