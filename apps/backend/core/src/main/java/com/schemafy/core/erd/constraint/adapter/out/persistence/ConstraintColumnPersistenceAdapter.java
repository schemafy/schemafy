package com.schemafy.core.erd.constraint.adapter.out.persistence;
...
import com.schemafy.core.erd.constraint.application.port.out.DeleteConstraintColumnsByConstraintIdPort;
