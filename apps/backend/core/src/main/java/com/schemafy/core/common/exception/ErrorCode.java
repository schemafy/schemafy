...
public enum ErrorCode {
  ...
  WORKSPACE_INVITATION_ALREADY_PROCESSED(HttpStatus.CONFLICT, "INV005",
      "이미 처리된 워크스페이스 초대입니다."),
  PROJECT_INVITATION_ALREADY_PROCESSED(HttpStatus.CONFLICT, "INV006",
      "이미 처리된 프로젝트 초대입니다."),
  INVITATION_CONCURRENT_PROCESSED(HttpStatus.CONFLICT, "INV007",
