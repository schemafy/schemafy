...
public enum ErrorCode {
    ...
    WORKSPACE_ACCESS_DENIED(HttpStatus.FORBIDDEN, "W002",
            "워크스페이스 접근 권한이 없습니다."),
    WORKSPACE_SETTINGS_INVALID(HttpStatus.BAD_REQUEST, "W003",
            "워크스페이스 설정 형식이 올바르지 않습니다."),
    WORKSPACE_SETTINGS_TOO_LARGE(HttpStatus.BAD_REQUEST, "W004",
    ...
    LAST_ADMIN_CANNOT_BE_REMOVED(HttpStatus.BAD_REQUEST, "W010",
            "마지막 관리자는 제거할 수 없습니다."),
    LAST_ADMIN_CANNOT_CHANGE_ROLE(HttpStatus.BAD_REQUEST, "W011",
            "마지막 관리자의 권한은 변경할 수 없습니다."),
    LAST_ADMIN_CANNOT_LEAVE(HttpStatus.BAD_REQUEST, "W012",
