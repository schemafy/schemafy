...
public enum ErrorCode {
    ...
    WORKSPACE_ADMIN_REQUIRED(HttpStatus.FORBIDDEN, "W008",
            "관리자 권한이 필요합니다."),
    WORKSPACE_MEMBER_ALREADY_EXISTS(HttpStatus.CONFLICT, "W009",
            "이미 워크스페이스 멤버입니다."),
    WORKSPACE_MEMBER_NOT_FOUND(HttpStatus.NOT_FOUND, "W010",
            "워크스페이스 멤버를 찾을 수 없습니다."),
    WORKSPACE_MEMBER_LIMIT_EXCEEDED(HttpStatus.BAD_REQUEST, "W011",
