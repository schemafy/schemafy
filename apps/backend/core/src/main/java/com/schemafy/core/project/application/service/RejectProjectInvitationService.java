...
class RejectProjectInvitationService implements RejectProjectInvitationUseCase {

  private static final Logger log = LoggerFactory.getLogger(
      RejectProjectInvitationService.class);
  ...
  @Override
  public Mono<Void> rejectProjectInvitation(
      RejectProjectInvitationCommand command) {
