...
import com.schemafy.domain.erd.domain.exception.ColumnAutoIncrementNotAllowedException;
import com.schemafy.domain.erd.domain.exception.ColumnCharsetNotAllowedException;
import com.schemafy.domain.erd.domain.exception.ColumnDataTypeInvalidException;
import com.schemafy.domain.erd.domain.exception.ColumnLengthRequiredException;
import com.schemafy.domain.erd.domain.exception.ColumnNameDuplicateException;
import com.schemafy.domain.erd.domain.exception.ColumnNameInvalidException;
import com.schemafy.domain.erd.domain.exception.ColumnNameReservedException;
import com.schemafy.domain.erd.domain.exception.ColumnPositionInvalidException;
import com.schemafy.domain.erd.domain.exception.ColumnPrecisionRequiredException;
import com.schemafy.domain.erd.domain.exception.MultipleAutoIncrementColumnException;
