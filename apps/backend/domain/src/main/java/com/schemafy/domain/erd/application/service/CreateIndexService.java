...
import com.schemafy.domain.erd.application.port.in.CreateIndexColumnCommand;
import com.schemafy.domain.erd.application.port.in.CreateIndexCommand;
import com.schemafy.domain.erd.application.port.in.CreateIndexResult;
import com.schemafy.domain.erd.application.port.in.CreateIndexUseCase;
import com.schemafy.domain.erd.application.port.out.CreateIndexColumnPort;
import com.schemafy.domain.erd.application.port.out.CreateIndexPort;
...
import com.schemafy.domain.erd.application.port.out.IndexExistsPort;
...
import com.schemafy.domain.erd.domain.exception.IndexNameDuplicateException;
