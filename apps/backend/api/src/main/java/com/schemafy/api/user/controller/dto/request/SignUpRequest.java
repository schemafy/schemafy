...
public record SignUpRequest(
    ...
    @NotBlank(message = "비밀번호는 필수입니다.") @Size(min = UserPolicy.MIN_PASSWORD_LENGTH, max = UserPolicy.MAX_PASSWORD_LENGTH, message = "비밀번호는 8자 이상 72자 이하여야 합니다.") String password,
