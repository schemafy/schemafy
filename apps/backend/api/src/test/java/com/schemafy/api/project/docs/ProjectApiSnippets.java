  ...
  private static FieldDescriptor[] projectResponseFields() {
    return new FieldDescriptor[] {
      ...
      fieldWithPath("updatedAt").type(JsonFieldType.STRING)
          .description("수정 시각"),
      fieldWithPath("currentUserRole").type(JsonFieldType.STRING)
  ...
  private static FieldDescriptor[] projectSummaryFields(String prefix) {
    return new FieldDescriptor[] {
      ...
      fieldWithPath(prefix + "workspaceId").type(JsonFieldType.STRING)
          .description("소속 워크스페이스 ID"),
      fieldWithPath(prefix + "dbVendorId").type(JsonFieldType.NUMBER)
          .description("DB 벤더 프로필 ID"),
  ...
  public static Snippet createProjectRequest() {
    return requestFields(
        ...
        fieldWithPath("description").type(JsonFieldType.STRING)
            .description("프로젝트 설명").optional(),
        fieldWithPath("dbVendorId").type(JsonFieldType.NUMBER)
    ...
    return createResponseFieldsSnippet(
        successResponseFields(
            fieldWithPath("content[]")
                .type(JsonFieldType.ARRAY)
                .description("멤버 목록"),
            fieldWithPath("content[].projectId")
                .type(JsonFieldType.STRING)
                .description("프로젝트 ID"),
