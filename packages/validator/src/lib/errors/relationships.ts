...
export const RelationshipNameChangeSameError = createErrorClass(
  "RelationshipNameChangeSame",
  {
...
export const RelationshipCardinalityChangeSameError = createErrorClass(
  "RelationshipCardinalityChangeSame",
  {
    code: ERROR_CODES.RELATIONSHIP_CARDINALITY_CHANGE_SAME,
    messageTemplate:
      "Cannot change relationship '{0}' cardinality same as before",
    createDetails: (relationshipId: string) => ({ relationshipId }),
  },
);
