...
export const AutoIncrementColumnError = createErrorClass('AutoIncrementColumn', {
  code: ERROR_CODES.AUTO_INCREMENT_INVALID,
  messageTemplate: 'Invalid Auto Increment column: {0}',
  createDetails: (reason: string) => ({ reason }),
});

export const DefaultValueIncompatibleError = createErrorClass('DefaultValueIncompatible', {
...
export const LastColumnCannotDeleteError = createErrorClass('LastColumnCannotDelete', {
