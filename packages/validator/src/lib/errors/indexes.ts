...
export const IndexColumnNotUniqueError = createErrorClass('IndexColumnNotUnique', {
...
export const DuplicateIndexDefinitionError = createErrorClass('DuplicateIndexDefinition', {
...
export const IndexColumnNotExistError = createErrorClass('IndexColumnNotExist', {
...
export const IndexColumnSortDirInvalidError = createErrorClass('IndexColumnSortDirInvalid', {
