...
const ERROR_DEFINITIONS: Record<keyof typeof ERROR_CODES, ErrorDefinition> = {
  ...
  SCHEMA_NAME_NOT_UNIQUE: {
    ...
    messageTemplate:
      "Schema name '{0}' already exists. Schema names must be unique",
  ...
  COLUMN_NAME_INVALID: {
    ...
    messageTemplate:
      "Column name '{0}' is invalid. Name must be between {1} and {2} characters.",
  ...
  CONSTRAINT_COLUMN_SEQ_ERROR: {
    ...
    messageTemplate:
      "Column sequence in constraint '{0}' must be consecutive starting from 1.",
    createDetails: (constraintName: string) => ({ constraintName }),
  },
  RELATIONSHIP_COLUMN_SEQ_ERROR: {
    code: ERROR_CODES.RELATIONSHIP_COLUMN_SEQ_ERROR,
    messageTemplate:
      "Column sequence in relationship '{0}' must be consecutive starting from 1.",
  ...
  IDENTIFYING_RELATIONSHIP_ORDER_ERROR: {
    ...
    messageTemplate:
      "Column order mismatch in identifying relationship '{0}': {1}",
  ...
  RELATIONSHIP_COLUMN_MAPPING_DUPLICATE: {
    ...
    messageTemplate:
      "Column mapping already exists in relationship '{0}': {1} -> {2}",
    createDetails: (
  ...
  RELATIONSHIP_COLUMN_TYPE_INCOMPATIBLE: {
    ...
    messageTemplate:
      "Related columns must have compatible data types in relationship '{0}': {1} <-> {2}",
    createDetails: (
      relationshipName: string,
      srcColumn: string,
      tgtColumn: string,
  ...
  RELATIONSHIP_DELETE_SET_NULL_ERROR: {
    ...
    messageTemplate:
      "ON DELETE SET NULL requires nullable foreign key columns in relationship '{0}': {1}",
    createDetails: (
      relationshipName: string,
  ...
  SCHEMA_IN_USE: {
    ...
    messageTemplate:
      "Schema '{0}' cannot be deleted because it contains {1} table(s)",
    createDetails: (schemaId: string, tableCount: number) => ({
      schemaId,
      tableCount,
    }),
  },
  TABLE_NOT_EXIST: {
    ...
    createDetails: (tableId: string, schemaId: string) => ({
      tableId,
      schemaId,
    }),
  },
  ...
  COLUMN_IN_USE: {
    ...
    messageTemplate:
      "Column '{0}' cannot be deleted because it is used by: {1}",
  ...
  CONSTRAINT_IN_USE: {
    ...
    messageTemplate:
      "Constraint '{0}' cannot be deleted because it is referenced by relationships: {1}",
    createDetails: (
      constraintId: string,
  ...
  LAST_SCHEMA_CANNOT_DELETE: {
    ...
    messageTemplate:
      "Cannot delete the last schema '{0}'. Database must have at least one schema",
    createDetails: (schemaId: string) => ({ schemaId }),
  },
  ...
  PRIMARY_KEY_CANNOT_DELETE: {
    ...
    messageTemplate:
      "Primary Key constraint '{0}' cannot be deleted from table '{1}'",
...
export const SchemaNotExistError = createErrorClass(
  "SchemaNotExist",
  ERROR_DEFINITIONS.SCHEMA_NOT_EXIST,
);
export const SchemaNameInvalidError = createErrorClass(
  "SchemaNameInvalid",
  ERROR_DEFINITIONS.SCHEMA_NAME_INVALID,
);
...
export const TableEmptyColumnError = createErrorClass(
  "TableEmptyColumn",
  ERROR_DEFINITIONS.TABLE_EMPTY_COLUMN,
);
export const TableNameNotUniqueError = createErrorClass(
  "TableNameNotUnique",
  ERROR_DEFINITIONS.TABLE_NAME_NOT_UNIQUE,
);
export const ColumnNotExistError = createErrorClass(
  "ColumnNotExist",
  ERROR_DEFINITIONS.COLUMN_NOT_EXIST,
);
...
export const ColumnNameInvalidError = createErrorClass(
  "ColumnNameInvalid",
  ERROR_DEFINITIONS.COLUMN_NAME_INVALID,
);
...
export const IndexNameNotUniqueError = createErrorClass(
  "IndexNameNotUnique",
  ERROR_DEFINITIONS.INDEX_NAME_NOT_UNIQUE,
);
export const IndexTypeInvalidError = createErrorClass(
  "IndexTypeInvalid",
  ERROR_DEFINITIONS.INDEX_TYPE_INVALID,
);
...
export const IndexColumnSeqError = createErrorClass(
  "IndexColumnSeq",
  ERROR_DEFINITIONS.INDEX_COLUMN_SEQ_ERROR,
);
...
export const PrimaryKeyRequiredError = createErrorClass(
  "PrimaryKeyRequired",
  ERROR_DEFINITIONS.PRIMARY_KEY_REQUIRED,
);
export const PrimaryKeyNullableError = createErrorClass(
  "PrimaryKeyNullable",
  ERROR_DEFINITIONS.PRIMARY_KEY_NULLABLE,
);
...
export const DefaultConstraintError = createErrorClass(
  "DefaultConstraint",
  ERROR_DEFINITIONS.DEFAULT_CONSTRAINT_ERROR,
);
...
export const RelationshipEmptyError = createErrorClass(
  "RelationshipEmpty",
  ERROR_DEFINITIONS.RELATIONSHIP_EMPTY_ERROR,
);
...
export const SchemaInUseError = createErrorClass(
  "SchemaInUse",
  ERROR_DEFINITIONS.SCHEMA_IN_USE,
);
export const TableNotExistError = createErrorClass(
  "TableNotExist",
  ERROR_DEFINITIONS.TABLE_NOT_EXIST,
);
export const TableInUseError = createErrorClass(
  "TableInUse",
  ERROR_DEFINITIONS.TABLE_IN_USE,
);
export const ColumnInUseError = createErrorClass(
  "ColumnInUse",
  ERROR_DEFINITIONS.COLUMN_IN_USE,
);
export const ColumnInPrimaryKeyError = createErrorClass(
  "ColumnInPrimaryKey",
  ERROR_DEFINITIONS.COLUMN_IN_PRIMARY_KEY,
);
export const IndexNotExistError = createErrorClass(
  "IndexNotExist",
  ERROR_DEFINITIONS.INDEX_NOT_EXIST,
);
export const ConstraintNotExistError = createErrorClass(
  "ConstraintNotExist",
  ERROR_DEFINITIONS.CONSTRAINT_NOT_EXIST,
);
export const ConstraintInUseError = createErrorClass(
  "ConstraintInUse",
  ERROR_DEFINITIONS.CONSTRAINT_IN_USE,
);
